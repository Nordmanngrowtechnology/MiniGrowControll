...
constexpr size_t PUMP_RELAY_1 = 4; //!< Relays we control on GPIO
constexpr size_t PUMP_RELAY_2 = 5; //!< Relays we control on GPIO
constexpr size_t PUMP_RELAY_3 = 12; //!< Relays we control on GPIO
constexpr size_t PUMP_RELAY_4 = 13; //!< Relays we control on GPIO
auto GrowPumpOne = ESP32_WaterPumpIO(PUMP_RELAY_1, 400, 'Growroom_1');
auto GrowPumpTow = ESP32_WaterPumpIO(PUMP_RELAY_2, 400, 'Growroom_2');
auto GrowPumpThree = ESP32_WaterPumpIO(PUMP_RELAY_3, 400, 'Growroom_3');
auto GrowPumpFour = ESP32_WaterPumpIO(PUMP_RELAY_4, 400, 'Growroom_4');
// #end WATERING <<< ***
